...
from app.routers.saved_internships import (
    router as saved_internships_router
)
...
from app.routers.preparation import (
    router as preparation_router,
)

from app.routers.preparation_chat import (
    router as preparation_chat_router,
)
